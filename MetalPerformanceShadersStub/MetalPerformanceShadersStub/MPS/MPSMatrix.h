 ...
 */
@property (readwrite, nonatomic) NSInteger rowBytes;
 ...
 *              class.
 */
+(__nonnull instancetype) matrixDescriptorWithDimensions: (NSInteger)              rows
 ...
 */
+(size_t) rowBytesFromColumns: (NSInteger) columns
                     dataType: (MPSDataType) dataType;
