 ...
 */
@property (readwrite, nonatomic) NSInteger featureChannels;

/*! @property   numberOfImages
 *  @abstract   The number of images for batch processing.   Default = 1.
 */
@property (readwrite, nonatomic) NSInteger numberOfImages;
...
+(__nonnull instancetype) imageDescriptorWithChannelFormat: (MPSImageFeatureChannelFormat)channelFormat
                                           ...
                                           featureChannels: (NSInteger)featureChannels;
...
@end
    ...
    typedef NS_ENUM(NSInteger, MPSPurgeableState)
    {
 ...
 */
@property (readonly, nonatomic) NSInteger featureChannels;
 ...
 */
@property (readonly, nonatomic) NSInteger precision;
...
-(nonnull instancetype) initWithTexture: (nonnull id <MTLTexture>) texture
                        featureChannels: (NSInteger) featureChannels NS_UNAVAILABLE;
 ...
 */
@property (readwrite, nonatomic)  NSInteger  readCount;
