 ...
 */
@property (readwrite, nonatomic) NSInteger              destinationFeatureChannelOffset;
 ...
 */
@property(readwrite, nonatomic) NSInteger       kernelWidth;
 ...
 */
@property(readwrite, nonatomic) NSInteger      groups;
 ...
 */
+(nonnull instancetype) cnnConvolutionDescriptorWithKernelWidth: (NSInteger) kernelWidth
                                                   kernelHeight: (NSInteger) kernelHeight
                                           inputFeatureChannels: (NSInteger) inputFeatureChannels
                                          outputFeatureChannels: (NSInteger) outputFeatureChannels
...
#else
    typedef NS_ENUM(NSInteger, MPSCNNConvolutionFlags)
#endif
    {
        /*! Use default options */
 ...
 *              by offset.x - (kernelWidth>>1)
 */
@property(readonly, nonatomic) NSInteger       kernelWidth;
 ...
 *              by offset.y - (kernelHeight>>1)
 */
@property(readonly, nonatomic) NSInteger       kernelHeight;

/*! @property   inputFeatureChannels
 *  @abstract   The number of feature channels per pixel in the input image.
 */
@property(readonly, nonatomic) NSInteger       inputFeatureChannels;

/*! @property   outputFeatureChannels
 *  @abstract   The number of feature channels per pixel in the output image.
 */
@property(readonly, nonatomic) NSInteger       outputFeatureChannels;

/*! @property   strideInPixelsX
 *  @abstract   The output stride (downsampling factor) in the x dimension. The default value is 1.
 */
@property(readonly, nonatomic) NSInteger      strideInPixelsX;

/*! @property   strideInPixelsY
 *  @abstract   The output stride (downsampling factor) in the y dimension. The default value is 1.
 */
@property(readonly, nonatomic) NSInteger      strideInPixelsY;

/*! @property   groups
 *  @abstract   Number of groups input and output channels are divided into.
 */
@property(readonly, nonatomic) NSInteger      groups;
 ...
 */
-(nonnull instancetype) initWithDevice: (nonnull id <MTLDevice>) device
                           kernelWidth: (NSInteger) kernelWidth
                          kernelHeight: (NSInteger) kernelHeight;
...
-(nonnull instancetype) initWithDevice: (nonnull id <MTLDevice>) device
                           kernelWidth: (NSInteger) kernelWidth
                          kernelHeight: (NSInteger) kernelHeight
                       strideInPixelsX: (NSInteger) strideInPixelsX
                       strideInPixelsY: (NSInteger) strideInPixelsY NS_DESIGNATED_INITIALIZER;
...
-(nonnull instancetype) initWithDevice: (nonnull id <MTLDevice>) device
                           kernelWidth: (NSInteger) kernelWidth
                          kernelHeight: (NSInteger) kernelHeight NS_DESIGNATED_INITIALIZER;
 ...
 */
@property(readonly, nonatomic) NSInteger       kernelSize;
 ...
 */
-(nonnull instancetype) initWithDevice: (nonnull id <MTLDevice>) device
                            kernelSize: (NSInteger) kernelSize NS_DESIGNATED_INITIALIZER;
