...
#   define  MPS_SWIFT_NAME(_name)
...
#else
    typedef NS_OPTIONS(NSInteger, MPSKernelOptions)
#endif
    {
        /*! Use default options */
...
#else
    typedef NS_ENUM(NSInteger, MPSImageEdgeMode)
#endif
    {
    ...
    typedef NS_ENUM( NSInteger, MPSAlphaType )
    {
     ...
     *              byte.
     */
    typedef NS_ENUM(NSInteger, MPSImageFeatureChannelFormat)
    {
        /*! invalid format */
