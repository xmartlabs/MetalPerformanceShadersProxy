...
-(void) encodeToCommandBuffer: (nonnull id <MTLCommandBuffer>) commandBuffer
              ...
              histogramOffset: (NSInteger) histogramOffset;
...
-(void) encodeTransformToCommandBuffer: (nonnull id <MTLCommandBuffer>) commandBuffer
                 ...
                 sourceHistogramOffset: (NSInteger) sourceHistogramOffset
                      desiredHistogram: (nonnull id <MTLBuffer>) desiredHistogram
                desiredHistogramOffset: (NSInteger) desiredHistogramOffset;
